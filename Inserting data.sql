...
INSERT INTO Readers (name, contact_data, reader_number) VALUES
  ...
  ('Анна Иванова', 'anna@example.com', 'R004');
...
INSERT INTO Books (name, ISBN, author_id, publisher_id, genre_id, department_id, copies) VALUES
  ...
  ('Властелин колец', '978-5-389-19001-3', 4, 4, 4, 1, 6),
  ('Игра престолов', '978-5-389-26001-2', 5, 4, 4, 1, 7),
  ('Анна Каренина', '978-5-389-08711-5', 3, 3, 1, 1, 12),
  ('Процесс', '978-5-17-103855-4', 2, 2, 2, 2, 5);
...
INSERT INTO BookReservations (name, book_id, reader_id, staff_id, reservation_date) VALUES
  ...
  ('Резерв: Властелин колец', 4, 4, 4, '2023-04-05'),
  ('Резерв: Игра престолов', 5, 1, 1, '2023-05-05');
